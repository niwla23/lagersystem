...
import (
	...
	"github.com/niwla23/lagersystem/manager/ent/generated"
)

// The BoxFunc type is an adapter to allow the use of ordinary
// function as Box mutator.
type BoxFunc func(context.Context, *generated.BoxMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f BoxFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.BoxMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.BoxMutation", m)
}

// The PartFunc type is an adapter to allow the use of ordinary
// function as Part mutator.
type PartFunc func(context.Context, *generated.PartMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f PartFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.PartMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.PartMutation", m)
}
...
type PropertyFunc func(context.Context, *generated.PropertyMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f PropertyFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.PropertyMutation); ok {
		return f(ctx, mv)
	}
...
type WarehouseFunc func(context.Context, *generated.WarehouseMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f WarehouseFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.WarehouseMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.WarehouseMutation", m)
}
