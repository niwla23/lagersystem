...
// QueryStoredBox chains the current query on the "storedBox" edge.
func (pq *PositionQuery) QueryStoredBox() *BoxQuery {
...
// WithStoredBox tells the query-builder to eager-load the nodes that are connected to
// the "storedBox" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *PositionQuery) WithStoredBox(opts ...func(*BoxQuery)) *PositionQuery {
	query := (&BoxClient{config: pq.config}).Query()
