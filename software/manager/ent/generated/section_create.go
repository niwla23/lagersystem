...
func (sc *SectionCreate) defaults() error {
	if _, ok := sc.mutation.CreatedAt(); !ok {
		if section.DefaultCreatedAt == nil {
			return fmt.Errorf("generated: uninitialized section.DefaultCreatedAt (forgotten import generated/runtime?)")
		}
	...
	if _, ok := sc.mutation.UpdatedAt(); !ok {
		if section.DefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized section.DefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (sc *SectionCreate) check() error {
	if _, ok := sc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`generated: missing required field "Section.createdAt"`)}
	}
	if _, ok := sc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`generated: missing required field "Section.updatedAt"`)}
	}
	return nil
}
