...
func (pc *PropertyCreate) defaults() error {
	if _, ok := pc.mutation.CreatedAt(); !ok {
		if property.DefaultCreatedAt == nil {
			return fmt.Errorf("generated: uninitialized property.DefaultCreatedAt (forgotten import generated/runtime?)")
		}
	...
	if _, ok := pc.mutation.UpdatedAt(); !ok {
		if property.DefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized property.DefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (pc *PropertyCreate) check() error {
	if _, ok := pc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`generated: missing required field "Property.createdAt"`)}
	}
	if _, ok := pc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`generated: missing required field "Property.updatedAt"`)}
	}
	if _, ok := pc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`generated: missing required field "Property.name"`)}
	}
	if v, ok := pc.mutation.Name(); ok {
		if err := property.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`generated: validator failed for field "Property.name": %w`, err)}
		}
	}
	if _, ok := pc.mutation.Value(); !ok {
		return &ValidationError{Name: "value", err: errors.New(`generated: missing required field "Property.value"`)}
	}
	if v, ok := pc.mutation.Value(); ok {
		if err := property.ValueValidator(v); err != nil {
			return &ValidationError{Name: "value", err: fmt.Errorf(`generated: validator failed for field "Property.value": %w`, err)}
		}
	}
	if _, ok := pc.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`generated: missing required field "Property.type"`)}
	}
	if v, ok := pc.mutation.GetType(); ok {
		if err := property.TypeValidator(v); err != nil {
			return &ValidationError{Name: "type", err: fmt.Errorf(`generated: validator failed for field "Property.type": %w`, err)}
		}
	}
	return nil
}
