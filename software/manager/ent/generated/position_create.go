...
func (pc *PositionCreate) defaults() error {
	if _, ok := pc.mutation.CreatedAt(); !ok {
		if position.DefaultCreatedAt == nil {
			return fmt.Errorf("generated: uninitialized position.DefaultCreatedAt (forgotten import generated/runtime?)")
		}
	...
	if _, ok := pc.mutation.UpdatedAt(); !ok {
		if position.DefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized position.DefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (pc *PositionCreate) check() error {
	if _, ok := pc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`generated: missing required field "Position.createdAt"`)}
	}
	if _, ok := pc.mutation.UpdatedAt(); !ok {
